...
pub const TOOL_DEFS: &[ToolDefinition] = &[
    ...
    ToolDefinition {
        ...
        input_schema: r#"{"type":"object","properties":{"agent_id":{"type":"string","description":"Agent to build timeline for"},"window_secs":{"type":"integer","description":"Timeline window in seconds","default":604800}},"required":["agent_id"]}"#,
    },
    ToolDefinition {
        name: "violation_archaeology_predict",
        description: "Predict future violations based on historical velocity and acceleration",
        input_schema: r#"{"type":"object","properties":{"agent_id":{"type":"string","description":"Agent to predict for"},"forecast_days":{"type":"integer","description":"Days to forecast ahead","default":7}},"required":["agent_id"]}"#,
    },
    ToolDefinition {
        name: "violation_archaeology_compare",
        description: "Compare violation patterns across multiple agents to rank risk",
        input_schema: r#"{"type":"object","properties":{"agent_ids":{"type":"array","items":{"type":"string"},"description":"Agent IDs to compare"}},"required":["agent_ids"]}"#,
    },
    ...
    ToolDefinition {
        ...
        input_schema: r#"{"type":"object","properties":{"max_agents":{"type":"integer","description":"Maximum concurrent agents","default":50},"requests_per_agent":{"type":"integer","description":"Requests per agent","default":20}}}"#,
    },
    ToolDefinition {
        name: "contract_simulation_optimize",
        description: "Suggest contract optimizations based on simulation bottleneck analysis",
        input_schema: r#"{"type":"object","properties":{"scenario_count":{"type":"integer","description":"Scenarios for baseline simulation","default":100}}}"#,
    },
    ToolDefinition {
    ...
    ToolDefinition {
        ...
        input_schema: r#"{"type":"object","properties":{"federation_id":{"type":"string","description":"Federation ID"},"member_id":{"type":"string","description":"Member organization ID ratifying"}},"required":["federation_id","member_id"]}"#,
    },
    ToolDefinition {
        name: "federated_governance_sync",
        description: "Sync policies across federation members and detect conflicts",
        input_schema: r#"{"type":"object","properties":{"federation_id":{"type":"string","description":"Federation ID"}},"required":["federation_id"]}"#,
    },
    ToolDefinition {
