//! Conservation tests for AgenticContract.
//!
...
use agentic_contract::cache::LruCache;
use agentic_contract::metrics::tokens::{Layer, TokenMetrics};
use agentic_contract::query::budget::TokenBudget;
use agentic_contract::query::intent::ExtractionIntent;
